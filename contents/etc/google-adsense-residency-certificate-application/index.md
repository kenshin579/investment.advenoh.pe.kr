...
구글 애드센스에서 수익이 나고 있다면 싱가포르 세금 정보를 입력해야 한다. 이때 세금 원천징수를 막으려면 `거주자증명서`를 제출해야 한다.

이 증명서가 있으면 거주 국가에서 세금을 신고하고 납부한다는 걸 증명할 수 있어, 싱가포르에서 세금이 원천징수되는 걸 피할 수 있다. 싱가포르 세금 정보 입력 화면에서 `거주자증명서`를 첨부하게 되어 있으니, 이 증명서를 어디서 어떻게 발급받는지 알아보자.
