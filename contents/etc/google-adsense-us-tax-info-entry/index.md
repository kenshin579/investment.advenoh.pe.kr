...
정확한 세금 정보를 제공하지 않으면 수익 지급이 지연되거나 중단될 수 있다. 세금 정보가 없으면 최대 30%까지 원천 징수가 적용되기 때문에 제대로 입력해 두는 게 좋다.
...
조세 조약에 따라 인하된 원천징수세율을 제출을 신청하시나요?
...
1. `우편 주신 중지(권장)`을 선택하고 `우편 수신 중지에 동의합니다`에도 체크한다.
