...
이 셋이 맞물리면 같은 투자를 해도 일반 계좌 대비 세금이 절반 이하로 줄어든다.
...
ISA는 **운용 방식**과 **소득 수준** 두 가지 기준으로 나뉜다. 어떤 유형을 고르느냐에 따라 투자 자유도와 비과세 한도가 달라진다.
...
같은 투자를 했는데 계좌만 ISA로 바꿔도 **46만 원의 세금 차이**가 난다. 투자 규모가 크고 기간이 길수록 이 차이는 더 벌어진다.

## 4.2 손익 통산이 중요한 이유

투자를 하다 보면 모든 상품이 수익을 내지는 않는다. 어떤 ETF는 오르고 어떤 펀드는 내린다. 일반 계좌에서는 손실이 난 상품과 상관없이 수익이 난 상품에만 세금을 내야 한다. 투자자 입장에선 손해다.

ISA는 계좌 안 모든 상품의 손익을 합쳐 **순이익**에만 과세하므로, 손실이 나도 세금 부담이 줄어든다. 여러 상품에 분산 투자하는 사람일수록 손익 통산의 효과가 크다.
...
비과세 한도를 넘겨도 일반 계좌 대비 세금이 **절반 수준**이다.
...
ISA의 혜택은 비과세·분리과세에서 끝나지 않는다. **만기 후 연금계좌로 전환하면 추가 세액공제 300만 원**을 받을 수 있고, 전환 금액 대부분이 연금계좌 내 **비과세 재원**이 되어 은퇴 후 세금 없이 인출할 수 있다.
