...
어느 쪽이든 공제 효과는 같으니 본인 소비 패턴에 맞는 방식을 쓰면 된다.
...
아니다. 카드 소비 공제에는 **한도**(최대 300만 원)가 있고, 공제를 위해 불필요한 지출을 늘리면 오히려 손해다. 총급여 25%를 넘긴 후의 추가 사용분만 공제 대상이니, 평소 쓰는 범위 안에서 결제 수단만 바꾸는 정도가 적당하다.

**Q. 연금저축 꼭 해야 하나?**

의무는 아니다. 다만 세액공제 효과가 명확하게 계산되는 항목이라, 900만 원을 납입하면 최대 148.5만 원(총급여 5,500만 원 이하 기준)을 돌려받는다. 여유 자금이 있다면 챙겨두는 편이 낫다.
