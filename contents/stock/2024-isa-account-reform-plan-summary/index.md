...
금종세자(금융소득종합세 대상자)인 경우 ISA 계좌 가입이 불가능했다. 연간 금융소득이 2천만원을 초과하면 최고 45%까지 세금을 내야 한다(10억원 초과 시). ISA 혜택을 받을 수 없으니 금종세자들은 해외 주식 투자를 선호했고, 그만큼 국내 자금이 해외로 빠져나갔다. 이번 개정안에는 금종세자도 ISA 계좌를 만들 수 있게 해서 국내 투자를 끌어들이려는 방안이 추가됐다.
...
- 금투세를 폐지하면 세금 부담이 줄어 투자자들이 주식에 자금을 더 넣을 가능성이 커진다. 금융 시장 활성화를 노린 정책 중 하나다. 다만 폐지하면 그만큼 세입이 줄어 정부 재정 수입이 감소하는 단점도 있다.
