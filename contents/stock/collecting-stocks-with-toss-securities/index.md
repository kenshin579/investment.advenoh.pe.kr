...
- 해외 주식을 모으기하는 경우 부족한 금액은 자동 환전되는데, 환전 수수료 혜택을 받으려면 환전 시점을 따로 챙겨야 한다
...
해외 주식에 투자할 경우 미리 환전을 해두는 게 좋다. 미국 주식 매수는 국내와 달리 야간에 진행되는데, 이 시간대는 환전 우대를 받을 수 없어서 0.5%의 높은 수수료가 붙는다. 넉넉하게 미리 환전해두기를 추천한다.
