...
`유상증자`는 기업이 자금 조달을 목적으로 새로운 주식을 발행하여 투자자들에게 판매하는 방식이다. 보통 기존 주가보다 낮은 가격으로 발행되기 때문에 주식 공급량이 늘면서 주가에 부담을 주고 기존 주주의 지분 가치가 희석된다. 기업 입장에서는 자금을 확보하는 방법이지만, 주주에게는 단기적으로 악재인 경우가 많다.
...
`무상증자`가 이루어지면 시장에서 해당 기업의 주식 수가 증가한다. 그런데 `무상증자` 공시 이후 오히려 주가가 급등하는 경우가 많다. 이유는 다음과 같다.
...
`무상증자`는 기업이 재무적으로 안정적이라는 신호를 줄 수 있다. 다만 발표 후 주가가 급등하더라도 이는 대체로 투자 심리와 유동성 증가에 따른 것이지, 기업의 실질 가치가 늘어난 것은 아니다. 시가총액이 그대로라는 점을 기억하면 된다.

투자 전에는 신주배정기준일과 공시 내용을 직접 확인하자.
