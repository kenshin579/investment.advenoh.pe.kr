...
## 1.1 금융소득 종합과세란?
<br>
금융소득종합과세란 이자나 배당 같은 금융 소득을 합산해서 세금을 부과하는 제도이다. 각 금융 수익에 따로 세금을 매기는 게 아니라 모두 합쳐 하나의 소득으로 보고 세액을 계산한다.
...
- ISA (개인 종합자산 관리 계좌) 이용하기
    ...
    - 투자로 얻은 순이익 중 200만 원까지는 세금을 매지지 않고 그 이상의 수익은 9.9% 세율로 분리과세를 적용한다. ISA 계좌 안에 있는 상품들끼리는 손실과 이익을 합쳐서 계산하기 때문에 과세 대상 금액을 줄일 수 있다
