...
description: "월별 투자 금액을 확인하는 방법으로 미래에셋증권 HTS에서 국내주식(0616 주식월별손익현황), 해외주식(9438 해외매매일지) 확인법과 구글시트 피봇테이블을 활용한 월별 투자 현황 분석 방법을 상세히 안내합니다."
date: 2024-06-08
update: 2024-08-08
category: Stock
tags:
...
여러 계좌에서 여러 주식을 매수하다 보면, 내가 얼마나 매수했는지 감이 오지 않을 때가 있다. 사람마다 투자 스타일이 다르겠지만, 개인적으로는 구체적인 매매 전략을 세우고 정확한 투자 금액을 정하지 않는 편이다. 한 번에 모든 주식을 사지 않고 분할 매수를 한다. 가격이 더 내려간 주식을 추가로 매수하다 보니 시간이 지나면 내가 얼마나 매수했는지 알기 어렵다.
...
다른 방법으로는 직접 수동으로 확인하는 것이다. 개인적으로 매매 내역을 구글 시트로 관리하고 있다. 번거로운 작업이지만, 구글 시트에서 관심 종목을 만들고 매수와 매도 종목을 정리하면 내 주식에 관심을 더 가지게 된다. 부족한 부분을 공부하는 목적도 크다. 내가 무엇을 하고 있는지 명확히 알 수 있어서 이렇게 관리한다.
