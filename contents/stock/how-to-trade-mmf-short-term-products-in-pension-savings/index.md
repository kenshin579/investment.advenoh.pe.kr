...
연말 정산 세제 공제를 위해 매달 연금 계좌로 50만 원씩 이체하고, 적립식으로 성장주 ETF와 채권 ETF를 사 모으고 있다. 안전자산으로 채권형 ETF를 매수할 수도 있지만, 다른 대안인 MMF(Money Market Fund, 머니마켓펀드) 펀드도 매수할 수 있다.
...
`MMF`는 무엇이고 연금저축에서 어떻게 매수를 할 수 있는지 알아보았다. 연금저축에서 안전자산으로 채권형 ETF를 매수할 수도 있지만, `MMF`는 원금 손실의 위험이 상대적으로 낮기 때문에 고려해 볼 만하다. 자동 매수 기능도 있어서 신경 쓰지 않고 매월 적립식으로 안전자산을 모아갈 수 있다.
