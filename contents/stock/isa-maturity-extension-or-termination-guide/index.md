...
`ISA` 만기가 되면 계좌를 해제할 수도 있지만, 조건이 맞으면 연장할 수 있다.
...
`ISA` 계좌는 절세와 자산 관리에 쓸모가 많다. 만기가 됐다고 바로 해지하기보다는 본인 상황에 맞춰 연장 여부를 따져보는 게 좋다.

- 수익이 충분히 났고 비과세 한도를 채웠다면 해지를 고려해볼 수 있고
- 아직 한도가 남아 있거나 절세 혜택을 더 활용하고 싶다면 연장하는 것이 유리하다.

본인의 금융 소득 상황과 앞으로의 투자 계획을 보고 `ISA` 만기를 결정하면 된다.
