...
2025년 3월 4일, 한국거래소(`KRX`) 외에 대체거래소인 넥스트레이드(`NXT`)가 공식 출범한다. 이번 글에서는 `NXT`의 주요 특징과 투자자들에게 미치는 영향을 살펴본다.
...
`NXT`의 도입으로 `KRX`와 `NXT` 거래소를 합친 통합시세가 제공된다. 투자자들은 두 거래소의 시세를 한 화면에서 확인할 수 있다.
...
`NXT` 출범으로 거래시간이 늘어나고 중간가호가, 스톱지정가호가 같은 주문 방식이 새로 생겼다. 다만 어떤 거래소에서 어떻게 체결되는지 미리 익혀두는 게 좋겠다.
