...
1. 주가 안정
    - 시장 상황이 좋지 않을 때, 기업이 `자사주`를 매입하면 매수가 늘어 주가를 끌어올리는 효과가 있다
2. 주주가치 제고
...
`자사주`는 주주 가치를 높이고 주가를 안정시키는 데 쓰인다. 다만 취득에는 재무적 부담이 따르고 의결권 제한 같은 단점도 있다. 그래서 공시 내용을 잘 분석해 기업의 의도를 파악하는 것이 좋다.
