...
투자자 접근성을 높이는 `액면분할`은 대표적인 주주친화정책이다. 다만 실적이 뒷받침되지 않는 종목이 `액면분할`로 유통 주식 수가 갑자기 늘어나면, 오히려 대량 매도를 유발해 주가가 약세로 전환될 수 있다.

# 3. 마무리

`액면분할`은 기업이 투자자 접근성을 높이고 거래를 활성화하기 위한 수단이다. 주가를 낮춘다고 기업 가치가 늘어나는 것은 아니므로, 장기적인 성장 가능성을 함께 봐야 한다.

앞서 봤듯이 미국과 달리 국내에서는 `액면분할` 후 주가가 오히려 빠진 사례도 적지 않다. 그래서 액면분할 소식만 보고 따라 사기보다는, 실적이 뒷받침되는지를 같이 확인하는 편이 낫다.
