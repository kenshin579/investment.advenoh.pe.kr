...
카카오뱅크의 달러박스는 해외 주식을 거래하거나 달러를 직접 인출할 때 쓰기 좋다. 환전 수수료가 무료라 부담이 적고, 환율이 괜찮을 때 미리 달러를 사둘 수도 있다. 이 글에서는 달러박스로 달러를 환전하고 ATM에서 직접 출금하는 방법을 정리한다.
...
유리한 환율에 미리 환전해두고 필요할 때 현금으로 꺼내 쓸 수 있어, 해외 주식 투자나 여행을 준비한다면 한 번 써볼 만하다.
