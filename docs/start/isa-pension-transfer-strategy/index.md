...
description: "ISA 만기 후 연금계좌로 전환하면 추가 세액공제 300만 원을 받을 수 있다. 전환 조건, 세액공제 시뮬레이션, 비과세 재원 확보, 3년 사이클 반복 전략까지 정리한 스터디 노트입니다."
date: 2026-03-07
update: 2026-03-07
series: "연금저축 절세 전략"
category: Etc
...
- 3년 운용 후 전환 시뮬레이션과 누적 절세 효과
- 3년 사이클 반복 전략과 전환 시 반드시 지켜야 할 주의사항

> 이전 글: [ISA 계좌, 이것만 알면 된다 — 비과세·손익 통산·분리과세 총정리](/etc/isa-basics/)
...
ISA(Individual Savings Account, 개인종합자산관리계좌)는 하나의 계좌에서 예금, 펀드, ETF 등 다양한 금융상품에 투자할 수 있는 **만능 절세 계좌**다. 핵심 혜택은 세 가지다:

- **손익 통산**: 여러 상품의 이익과 손실을 합산하여 순이익에만 과세
- **비과세**: 순이익 중 200만 원(서민형 400만 원)까지 세금 0원
- **분리과세**: 비과세 한도 초과분도 15.4%가 아닌 9.9% 저율 과세
...
> ISA의 종류, 손익 통산, 비과세·분리과세 구조에 대한 자세한 내용은 [ISA 계좌, 이것만 알면 된다 — 비과세·손익 통산·분리과세 총정리](/etc/isa-basics/)를 참고한다.

이 혜택만으로도 충분히 매력적이지만, ISA의 진짜 가치는 만기 후 **연금계좌로 전환할 때** 나타난다. 이 글에서는 ISA 자체의 혜택보다 더 큰 절세 효과를 만들어내는 **만기 후 연금계좌 전환 전략**에 집중한다.
...
## 2.4 3년 운용 후 전환 시뮬레이션

구체적인 숫자로 ISA → 연금계좌 전환의 절세 효과를 확인해보자.
...
| 3년 운용 수익 | 약 946만 원 | 약 946만 원 |
| **3년 후 적립금** | **약 6,946만 원** | **약 6,946만 원** |
| 운용 수익에 대한 세금 | 946만 원 × 15.4% = **약 146만 원** | 200만 원 비과세 + 746만 원 × 9.9% = **약 74만 원** |
| **세금 차이** | | **약 72만 원 절세** |

ISA 계좌만으로도 일반 계좌 대비 약 72만 원을 절세할 수 있다. 하지만 여기서 끝이 아니다.

### 연금계좌 전환 시 추가 절세

ISA 적립금 약 6,946만 원 중 3,000만 원을 연금계좌로 전환한다고 가정하자.

| 항목 | 금액 | 비고 |
|------|------|------|
| ISA 전환 금액 | 3,000만 원 | |
| 추가 세액공제 대상 (10%) | 300만 원 | |
| **추가 세액공제 환급액** | **39.6만 원** | 300만 원 × 13.2% |
| 비과세 재원 확보 | 2,700만 원 | 연금 수령 시 세금 0원 |
| 나머지 ISA 잔액 | 약 3,946만 원 | ISA 비과세/분리과세 혜택 후 현금화 또는 재투자 |

### 1회 사이클 총 절세 효과 요약

| 절세 항목 | 금액 |
|----------|------|
| ISA 비과세·분리과세 절세 | 약 72만 원 |
| 연금전환 추가 세액공제 환급 | 약 39.6만 원 |
| 비과세 재원 확보 (미래 절세) | 2,700만 원 (연금소득세 약 149만 원 절감 효과) |
| **1회 사이클 총 절세 효과** | **약 261만 원** |

> 비과세 재원 절감 효과: 2,700만 원을 비과세가 아닌 과세 재원으로 연금 수령 시 5.5% 연금소득세 부과 기준 약 149만 원. 이 금액은 비과세 재원 덕분에 아낄 수 있는 세금이다.

이 사이클을 3년마다 반복하면 절세 효과가 누적된다. 30세부터 55세까지 약 8회 반복 시, 총 절세 효과는 **약 2,000만 원 이상**에 달한다.
...
실제 전환이 어떻게 이루어지는지 미래에셋증권을 기준으로 단계별로 정리한다. 다른 증권사도 큰 흐름은 비슷하지만, 메뉴 위치나 세부 절차는 다를 수 있다.

### 사전 준비

- ISA와 연금저축 계좌가 **같은 증권사(미래에셋)**에 있는지 확인
- 연금저축 계좌가 없다면 **만기 전에 미리 개설**해두어야 한다
- ISA 보유 상품(ETF, 펀드 등)을 **전량 매도하여 현금화** (실물 이전 불가)

### 전환 5단계

```
1단계: ISA 만기 해지 신청
       → 영업점 방문, ARS(1588-6800), 또는 모바일 앱(M-STOCK)
       → 보유 상품이 모두 현금화된 상태여야 함

2단계: 연금전환 대상 선택
       → 전환할 금액과 이동 대상 연금계좌(연금저축 또는 IRP)를 지정

3단계: 연금전환 신청
       → 모바일 앱 또는 영업점에서 '연금 전환' 메뉴로 신청
       → 주의: 일반 계좌이체가 아닌 반드시 '연금 전환' 전용 메뉴 사용

4단계: 연금계좌로 입금 확인
       → 신청 금액이 연금계좌로 정확히 입금되었는지 확인
       → 같은 증권사 내 이전이면 보통 1~2영업일 소요

5단계: 전환 완료 확인
       → 연금계좌에서 ISA 전환 금액이 정상 반영되었는지 확인
       → 연말정산 시 추가 세액공제(최대 300만 원) 자동 반영
```

> 전체 과정은 만기일로부터 **60일 이내**에 완료되어야 한다. 같은 증권사 내 전환은 비교적 간단하지만, 다른 금융기관으로 이전 시에는 처리 기간이 길어질 수 있으므로 여유를 두자.

## 4.3 전환 후 알아야 할 점

연금계좌로 이전된 금액은 이후 연금계좌의 규칙을 따른다. 전환 전에 이 점을 반드시 이해하고 있어야 한다.

> 미래에셋증권 ISA 문의: 고객센터 1588-6800 또는 영업점 방문
...
### Q. ISA 해지 후 개인 계좌를 거쳐 연금계좌로 이체하면 안 되나?

안 된다. ISA를 해지하면서 돈을 먼저 본인 계좌로 받고, 이후 연금계좌로 직접 이체하면 국세청 시스템에서 ISA 전환이 아닌 **일반 납입**으로 인식되어 추가 세액공제 300만 원을 받을 수 없다. 한번 잘못 처리하면 되돌릴 수 없으므로, 반드시 금융기관의 '연금 전환' 전용 메뉴를 사용해야 한다.

### Q. 60일 기한을 넘기면 어떻게 되나?
...
### Q. 만 55세 이전에 쓸 돈도 연금계좌로 전환해야 하나?

아니다. 연금계좌로 이전한 금액은 만 55세 이전에 꺼내면 16.5%의 기타소득세가 부과된다. 3~5년 내에 사용할 계획이 있는 자금이라면 연금계좌로 전환하지 않고, ISA를 일반 해지하여 비과세/분리과세 혜택만 받는 것이 더 유리할 수 있다.
