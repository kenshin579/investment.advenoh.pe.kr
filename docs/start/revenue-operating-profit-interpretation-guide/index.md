...
원가율(40%) + 판관비율(25%) = **65%** → 남는 돈 35%. 기술력이 곧 마진이다.
...
원가율(65%) + 판관비율(20%) = **85%** → 남는 돈 15%. 안정적인 수익 구조.
...
원가율(78%) + 판관비율(22%) = **100%** → 남는 돈 0%. 흑자 유지가 힘든 구조.
...
```mermaid
quadrantChart
    title 매출 vs 영업이익 해석 매트릭스
    x-axis "매출 감소" --> "매출 증가"
    y-axis "영업이익 감소" --> "영업이익 증가"
    quadrant-1 "이상적인 성장"
    quadrant-2 "효율 개선/구조조정"
    quadrant-3 "사업 위축 경고"
    quadrant-4 "성장 비용/질 나쁜 성장"
```
...
- 실적을 볼 때 "숫자 자체"보다 **"숫자 뒤의 이야기"**를 읽는 습관을 들이면 투자 판단의 질이 달라진다
